...
public:
        Pin() : port(AvrPort()), pin_index(0), pin_mask(0), pin_mask_inverted(~0) {}
        ...
        void setDirection(bool out) const { out ? port.setPinDirectionOut(pin_mask) : port.setPinDirectionIn(pin_mask_inverted); }
